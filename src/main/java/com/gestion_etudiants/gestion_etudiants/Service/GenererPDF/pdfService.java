...
//                     .setTextAlignment(TextAlignment.CENTER));
        ...
        //     byte[] photoDefaut = etudiant.getPhotoDefaut(); // Assurez-vous que c'est un tableau d'octets
        //     if (photoDefaut != null) {
        //         Image image = new Image(ImageDataFactory.create(photoDefaut));
        //         document.add(image); // Ajoutez l'image au document
        //     } else {
